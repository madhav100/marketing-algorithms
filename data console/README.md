...
## Generated artifacts
- `data cloud/data/objects-lake.json`, `data cloud/data/model-objects.json`, and `data cloud/data/lake-summary.json` are generated by ingestion and should not be manually edited.
